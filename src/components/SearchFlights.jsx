...
import { FaPlaneArrival, FaPlaneDeparture, FaUser, FaPassport } from 'react-icons/fa';
...
const SearchFlights = (props) => {
    ...
    return (
        <div className="container max-w-[1280px] mx-auto px-5">
            <div className="flex flex-col rounded-3xl p-8 gap-5 bg-white" style={{ boxShadow: "0 0 35px #ddd" }}>
